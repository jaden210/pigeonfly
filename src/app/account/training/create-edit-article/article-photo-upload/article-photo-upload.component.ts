...
import { takeLast, flatMap, catchError } from "rxjs/operators";
...
@Component({
  ...
  styleUrls: ["./article-photo-upload.component.css"]
})
export class ArticlePhotoDialog {
  previewImg;
  image;

  constructor(
    public dialogRef: MatDialogRef<ArticlePhotoDialog>,
